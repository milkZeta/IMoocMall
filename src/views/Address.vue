        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li  v-for="(item,index) in addressListFilter" @click="checkIndex=index,selectedAddId=item.addressId" v-bind:class="{'check':checkIndex==index}">
                    <dl>
                      <dt>{{item.userName}}</dt>
            ...
            <div class="next-btn-wrap">
              <router-link class="btn btn--m btn--red" href="#" v-bind:to="{path:'orderConfirm',query:{addressId:selectedAddId}}">Next</router-link >
            </div>
          </div>
        </div>
      </div>
      ...
      methods:{
        init(){
          axios.get('/users/addressList').then((response)=>{
           ...
           this.selectedAddId=this.addressList[0].addressId;
        })           
        },
        expand(){
          if(this.limit==3){
        ...
        setDefault(addressId){
           axios.post('/users/setDefalt',{addressId:addressId}).then((response)=>{
