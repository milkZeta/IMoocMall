          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{totalAmt | currency('￥')}}</span>
              </div>
              <div class="btn-wrap">
          ...
          editCart(flag,item){
            let productId=item.productId;
             if(flag=='add'){
              ...
              axios.post('users/cartEdit',{productId:productId,productNum:item.productNum,checked:item.checked}).then((response)=>{
                  let res=response.data;
              })
          },
          toggleCheckAll(){
            var checkedFlag=!this.checkAllFlag;
            this.cartList.forEach((item)=>{
              item.checked=checkedFlag;
            })
            axios.post('/users/editCheckAll',{checkAllFlag:checkedFlag}).then((response)=>{
               let res=response.data;
            })
          },
          checkOut(){
