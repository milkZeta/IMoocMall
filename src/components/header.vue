  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" @click="loadModalFlag=true" v-if="!nickName">Login</a>
      ...
      <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loadModalFlag}">
   <div class="md-modal-inner">
     <div class="md-top">
        <span v-text="nickName" v-if='nickName'></span>
       <div class="md-title"  @click="loadModalFlag=true">Login in</div>
       <button class="md-close" @click="loadModalFlag=false">Close</button>
     </div>
       ...
       <div class="confirm-tips">
         ...
         <ul>
           ...
           <li class="regi_form_input noMargin">
             ...
             <input type="password" tabindex="2" v-model='userPwd' name="password" @keyup.enter="login" class="regi_login_input"/>
           </li>
         </ul>
       </div>
...
<div class="md-overlay" v-if="loadModalFlag" @click="loadModalFlag=false"> </div>      
    </div>
  </div>
</header>
</template>
<script>
    ...
    export default{
      ...
      methods:{
        ...
        logout(){
          axios.post('/users/logout').then((resondse)=>{
           let res=resondse.data;
           if(res.status=="0"){
              this.nickName='';
           }
          })
